...
INSERT INTO "new_Proposal" ("budget", "clientCompany", "clientEmail", "clientName", "createdAt", "deliverables", "executiveSummary", "id", "pricingBreakdown", "projectDescription", "projectTitle", "scopeOfWork", "startDate", "status", "termsAndConditions", "timeline", "timelineDetails", "userId") SELECT "budget", "clientCompany", "clientEmail", "clientName", "createdAt", "deliverables", "executiveSummary", "id", "pricingBreakdown", "projectDescription", "projectTitle", "scopeOfWork", "startDate", "status", "termsAndConditions", "timeline", "timelineDetails", "userId" FROM "Proposal";
DROP TABLE "Proposal";
