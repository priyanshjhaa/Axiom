              ...
              <button
                ...
                onClick={async () => {
                  ...
                  try {
                    ...
                    alert('Test API failed. Check console for errors.');
                  }
                }}
                className="w-full py-2 px-4 bg-blue-500 text-white font-light rounded-lg hover:bg-blue-600 transition-all duration-300 text-sm mb-4"
                style={{ fontFamily: 'var(--font-inter)' }}
              >
                Test API Connection
              </button>
